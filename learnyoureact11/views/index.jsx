...
class TodoList extends React.Component {
    ...
    changeDetail(e) {
      this.setState(detailValue, e.value);
    }

    addTodo() {
      this.props.data.push({title: this.state.titleValue, detail: this.state.detailValue})
    }

    onDelete(title) {
      var removed = this.props.data.filter(function(el) { return el.title != title; }); 
      this.props.data = removed;
